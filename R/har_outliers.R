...
#'@description The function receives a dataset "data" and an "alpha" parameter (default 1.5), which controls the upper limit of the boxplot
#'
#'@details The function calls the "har_outliers" function internally to obtain a boolean vector "cond" with TRUE values for the values considered as outliers and FALSE for the others
#'
#'@param data
#'@param alpha
#'
