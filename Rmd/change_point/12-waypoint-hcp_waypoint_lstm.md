This notebook shows the `hcp_waypoint()` detector with an LSTM
autoencoder.
...
This version is the most time-series-specific one. It is a good second
step after the feed-forward baseline because it makes the sequential
