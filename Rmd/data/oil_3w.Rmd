...
This is a data-inspection notebook aimed at multivariate industrial series. The key point is to show how to identify the sensor columns and choose a first variable for visual inspection.
...
- plot the first sensor column together with its labels
...
har_plot(
  harbinger(),
  oil_type_1_info$first_series[[oil_type_1_info$plot_column]],
  event = oil_type_1_info$first_series$event
)
```
...
har_plot(
  harbinger(),
  oil_type_2_info$first_series[[oil_type_2_info$plot_column]],
  event = oil_type_2_info$first_series$event
)
```
...
har_plot(
  harbinger(),
  oil_type_4_info$first_series[[oil_type_4_info$plot_column]],
  event = oil_type_4_info$first_series$event
)
```
...
har_plot(
  harbinger(),
  oil_type_5_info$first_series[[oil_type_5_info$plot_column]],
  event = oil_type_5_info$first_series$event
)
```
...
har_plot(
  harbinger(),
  oil_type_6_info$first_series[[oil_type_6_info$plot_column]],
  event = oil_type_6_info$first_series$event
)
```
...
har_plot(
  harbinger(),
  oil_type_7_info$first_series[[oil_type_7_info$plot_column]],
  event = oil_type_7_info$first_series$event
)
```
...
har_plot(
  harbinger(),
  oil_type_8_info$first_series[[oil_type_8_info$plot_column]],
  event = oil_type_8_info$first_series$event
)
```
