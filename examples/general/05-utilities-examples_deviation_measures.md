...
This notebook demonstrates Harbinger utility deviation measures for summarizing residual magnitudes (L1 and L2) and plotting results for quick inspection. L1 emphasizes robustness to outliers; L2 emphasizes larger deviations. These aggregations feed subsequent filter criteria in the detection pipeline.
