...
This first visual pass establishes what the method should react to in the raw series. Keep the method summary in mind here, because adversarial Autoencoder (encode-decode): An adversarial autoencoder (AAE) augments a standard encoder-decoder with an adversarial objective on the latent code and the plot tells you whether that structure is clean, weak, local, repeated, or mixed with other effects.
...
![plot of chunk unnamed-chunk-5](fig/86-autoencoder-han_autoenc_adv_ed/unnamed-chunk-5-1.png)
...
The evaluation asks whether the reconstruction-based anomaly flags produced by `han_autoencoder(..., autoenc_adv_ed, ...)` match the labeled structure on this dataset. Read the scores as evidence about the method's assumptions in practice, not as detached summary numbers.
...
![plot of chunk unnamed-chunk-11](fig/86-autoencoder-han_autoenc_adv_ed/unnamed-chunk-11-1.png)
...
![plot of chunk unnamed-chunk-12](fig/86-autoencoder-han_autoenc_adv_ed/unnamed-chunk-12-1.png)
